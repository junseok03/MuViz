//constructor function for the needles extension
function Needles() {
	...
	this.draw = function() {
		...
		var currentBin = 0;
		push();
		fill(230, 230, 250, 225);
		//nested for loop to place plots in 2*2 grid.
		for (var i = 0; i < this.plotsDown; i++) {
			for (var j = 0; j < this.plotsAcross; j++) 
            {
                var x = j * width/2 + width/40;
				var y = i * height/2 + width/40;
				var w = this.plotWidth - width/40;
				var h = this.plotHeight - width/40;
